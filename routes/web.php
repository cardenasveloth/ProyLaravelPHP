...
Auth::routes();
    Route::get('/dashboard/post/index',[PostController::class,'index'])->name('homePost');
    Route::get('/dashboard/category/index',[CategorytController::class,'index'])->name('homeCate');
